...
def mapCorrelation(im, x_im, y_im, vp, xs, ys):
  ...
  for jy in range(0,nys):
    y1 = vp[1,:] + ys[jy] # 1 x 1076 - for each of 9 perturbations get the lidar pose perturbed y coord
...
if __name__ == '__main__':
  with np.load("../data/Hokuyo%d.npz" % 20) as data:
    lidar_ranges = data["ranges"]
  # show_lidar(lidar_ranges[:,0])
  test_mapCorrelation()
  # test_bresenham2D()